<template>
  <div class="chart__w">
    ...
    <div class="chart__select">
      <Selects :options="monthsData" v-model="activeMonth" placeholder="Выберите месяц" />
    </div>
...
const monthsData = ref<any>([
  {
    id: "Январь",
    name: "Январь",
    data: [1200, 1500, 800, 1100, 1600, 1400, 1050],
  },
  {
    id: "Февраль",
    name: "Февраль",
    data: [1300, 1400, 900, 1200, 1500, 1300, 950],
  },
  { id: "Март", name: "Март", data: [1100, 1600, 900, 1300, 1400, 1500, 1200] },
  {
    id: "Апрель",
    name: "Апрель",
    data: [1000, 1700, 800, 1400, 1600, 1100, 1300],
  },
  { id: "Май", name: "Май", data: [1400, 1300, 1100, 1500, 1800, 1400, 1150] },
  {
    id: "Июнь",
    name: "Июнь",
    data: [1200, 1600, 1000, 1300, 1700, 1200, 1400],
  },
  { id: "Июль", name: "Июль", data: [1100, 1500, 950, 1200, 1600, 1400, 1350] },
  {
    id: "Август",
    name: "Август",
    data: [1150, 1550, 1050, 1250, 1650, 1350, 1250],
  },
  {
    id: "Сентябрь",
    name: "Сентябрь",
    data: [1250, 1450, 1150, 1350, 1550, 1250, 1350],
  },
  {
    id: "Октябрь",
    name: "Октябрь",
    data: [1300, 1400, 1200, 1400, 1500, 1300, 1400],
  },
  {
    id: "Ноябрь",
    name: "Ноябрь",
    data: [1400, 1300, 1100, 1500, 1600, 1400, 1200],
  },
  {
    id: "Декабрь",
    name: "Декабрь",
    data: [1500, 1200, 1000, 1600, 1700, 1500, 1100],
  },
]);
